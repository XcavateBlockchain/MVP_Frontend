...
import DevProfileStatContianer from "../cards/DevProfileStatContianer";
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="mt-2">
                  <h5 className=" font-graphik-regular text-xl tracking-[0.5px] text-headers opacity-[0.8]">
                    {`Account created ${
                      user?.userData?.createdAt ? moment(user?.userData?.createdAt).format("MMM DD, YYYY") : ""
                    }`}
                  </h5>
                </div>
              </div>
              <div className="flex flex-row items-center justify-end">
                <button className=" flex w-[135px] h-[53px] rounded-lg bg-gradient-to-r from-[#F5A483] via-[#E574A5] via-[#354E78] to-[#2F8BB2] p-[2px] hover:scale-[1.01] active:scale-100 hover:shadow-sm mr-4">
                ...
                >
                  <h5 className=" font-dmsans-bold text-base text-white">{`Add property`}</h5>
                </button>
              </div>
            </div>
          </div>
