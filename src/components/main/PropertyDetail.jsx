...
import img from "../../assets/HighViewProp3-4.jpg";
          ...
          <div className="mt-5 h-[30rem] w-full p-5 flex flex-col rounded-md bg-white border border-gray-200  hover:bg-gray-100">
            ...
            <div className="h-[100%] mt-3">
              <iframe
                ...
                marginwidth="0"
                title="map"
                src="https://maps.google.com/maps?width=100%&amp;height=1000&amp;hl=en&amp;q=%C4%B0zmir+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed"
              ></iframe>
            </div>
          </div>
        </div>{" "}
